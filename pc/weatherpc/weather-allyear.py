...
for city, url in urls.items():
    ...
    try:
        ...
        weather.columns = ["城市", "当日信息", "最高气温", "最低气温", "天气", "风向信息"]
        ...
        weather.insert(loc=1, column='日期', value=result['日期'])

        weather.insert(loc=2, column='星期', value=result['星期'])

        weather.insert(loc=6, column='风向', value=result1['风向'])

        weather.insert(loc=7, column='级数', value=result1['级数'])
